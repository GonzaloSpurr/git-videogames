...
A puzzle game is a genre that challenges the player with a challenge that can be solved through skill and/or quick thinking. [Wikipedia](https://en.wikipedia.org/wiki/Puzzle_video_game)
